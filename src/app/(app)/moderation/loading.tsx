export default function ModerationLoading() {
  return (
    <div
      ...
      role="status"
    >
      <div className="overflow-hidden rounded-um-lg bg-um-ink-950 lg:grid lg:grid-cols-[minmax(0,1fr)_21rem]">
        <div className="px-6 py-10 sm:px-9 lg:px-11 lg:py-12">
          <div className="h-3 w-36 rounded bg-white/15" />
          <div className="mt-6 h-20 max-w-3xl rounded-um-sm bg-white/10 sm:h-28" />
          <div className="mt-6 h-4 max-w-2xl rounded bg-white/10" />
          <div className="mt-3 h-4 max-w-xl rounded bg-white/10" />
          <div className="mt-7 h-11 w-48 rounded-um-sm bg-um-gold-400/30" />
        </div>
        <div className="hidden border-l border-white/10 bg-white/[0.025] lg:block" />
      </div>

      <div className="mt-14 h-8 w-56 rounded-um-xs bg-black/10" />
      <div className="mt-5 grid border-y border-black/10 md:grid-cols-[1.2fr_1fr_1fr]">
        {[0, 1, 2].map((item) => (
      ...
      <div className="mt-6 overflow-hidden border-y border-black/10 bg-um-surface">
