export default function EditListingLoading() {
  return (
    <div aria-label="Loading listing" className="animate-pulse bg-um-ink-950 pb-24" role="status">
      <div className="mx-auto max-w-um-content px-5 py-12 sm:px-8 sm:py-14 lg:px-10 lg:py-16">
        <div className="h-3 w-24 rounded bg-white/[0.15]" />
        <div className="mt-5 h-14 w-72 max-w-full rounded bg-white/[0.15]" />
        <div className="mt-5 h-4 w-full max-w-lg rounded bg-white/10" />
      </div>
